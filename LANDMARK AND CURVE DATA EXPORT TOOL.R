#LANDMARK AND CURVE DATA EXPORT TOOL
...
#************************************************************************************
#SET WORKING DIRECTORY AND SELECT SOURCE NAME CSV FILE (WORKS!)####
...
#--> find a way to use the tktoplevel() fxn to always bring the dialogue box to the
  ...
  #+Set working directory (optional) (WORKS!)####
...
#***  
  ...
  #+Set shape names source file (mandatory) (WORKS!)####
...
#+Select shape name in GUI (WORKS...not pretty tho!)####
  ...
  #--> generate a selection pane from the ShapeNamesSource list
    ...
    repeat {
    #selection pane
    listBox_choice <- tk_select.list(title = "Select the StereoMorph shape data to import", 
...
#***********************************************************************************
#LOAD SHAPES DATA FOR ONE StereoMorph OUTPUT FILE AT A TIME (WORKS!)####
...
#***********************************************************************************
#EXTRACT SCALED LANDMARK DATA AND WRITE TO CSV (WORKS!)####
...
The name source file must contain the landmarks names exactly as imported into the stereomorph landmark digitization function.", 
                                                type = "ok")
